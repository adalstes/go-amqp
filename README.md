# **github.com/adalstes/go-amqp**

[![PkgGoDev](https://pkg.go.dev/badge/github.com/adalstes/go-amqp)](https://pkg.go.dev/github.com/adalstes/go-amqp)
...
[![Go Report Card](https://goreportcard.com/badge/github.com/adalstes/go-amqp)](https://goreportcard.com/report/github.com/adalstes/go-amqp)
[![GoDoc](https://godoc.org/github.com/adalstes/go-amqp?status.svg)](http://godoc.org/github.com/adalstes/go-amqp)
[![MIT licensed](https://img.shields.io/badge/license-MIT-blue.svg)](https://raw.githubusercontent.com/Azure/go-amqp/main/LICENSE)

github.com/adalstes/go-amqp is an AMQP 1.0 client implementation for Go.
...
```
go get -u github.com/adalstes/go-amqp
```
